...
params:
  spaceranger_dir: "~/OneDrive/BTC_DPTpilot1_spaceranger/BTC13"
...
```{r}
BTC13 <- Load10X_Spatial(params$spaceranger_dir)
dim(BTC13)
...
codaBTC13 <- as.data.frame(read.csv(params$coda_ann_path))
...
save(BTC13epit, file = 'BTC13epit_modscores.Rda')
```
